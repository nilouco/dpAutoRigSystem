...
class HeadDeformer(base.BaseLibrary):
    ...
    def create_head_def(self, dialog_name=None, hd_items=None, ctrl=None, deformed_by_items=None, guide_net=None, ui=True, *args):
        ...
        if hd_items:
            ...
            cmds.setAttr(twist_def_items[1]+".translateY", bbox_min_y)
            ...
            cmds.setAttr(squash_def_items[1]+".translateY", bbox_min_y)
            ...
            cmds.setAttr(side_bend_def_items[1]+".translateY", bbox_min_y)
            ...
            cmds.setAttr(front_bend_def_items[1]+".rotateY", -90)
            cmds.setAttr(front_bend_def_items[1]+".translateY", bbox_min_y)
            ...
            cmds.connectAttr(arrow_ctrl+".rotateY", twist_md+".input1Y", force=True)
            ...
            cmds.setAttr(arrow_ctrl_grp+".translateY", arrow_ctrl_height)
            ...
            top_symmetry_height = cmds.getAttr(symmetry_ctrl_zeros[1]+".translateY") - (bbox_size*0.3)
            cmds.setAttr(symmetry_ctrl_zeros[1]+".translateY", top_symmetry_height)
