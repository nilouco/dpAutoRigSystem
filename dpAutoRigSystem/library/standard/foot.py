    ...
    def rig_me(self, *args):
        ...
        if cmds.objExists(self.guide_base):
            ...
            for s, side in enumerate(self.sides):
                ...
                self.ar.naming.set_joint_label(foot_jnt, s+self.joint_label_add, 18, self.number_name+ "_"+ankle_rf_attr.capitalize())
                ...
                self.ar.naming.set_joint_label(middle_foot_jnt, s+self.joint_label_add, 18, self.number_name+"_"+middle_rf_attr.capitalize())
