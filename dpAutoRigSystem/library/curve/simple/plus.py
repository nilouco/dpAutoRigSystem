...
class Plus(curve.BaseCurve):
    ...
    def get_linear_points(self):
        ...
        """
        r = self.cv_size
        self.cv_points = [(-r, 0.33*r, 0), (-0.33*r, 0.33*r, 0), (-0.33*r, r, 0), (0.33*r, r, 0), (0.33*r, 0.33*r, 0),
    ...
    def get_cubic_points(self):
        ...
        """
        r = self.cv_size
        self.cv_points = [(-r, 0.33*r, 0), (-0.9*r, 0.33*r, 0), (-0.43*r, 0.33*r, 0), (-0.33*r, 0.33*r, 0), (-0.33*r, 0.43*r, 0), 
