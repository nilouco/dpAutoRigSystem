...
class Start(object):
    ...
    def wip(self):
        ...
        print("self.customAttr =", self.customAttr)
    ...
    def load_settings(self):
        ...
        #print("self.sets.lang =", self.sets.lang)
        #print("self.lang - from settings =", self.lang)
