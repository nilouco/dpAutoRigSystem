...
class DP_AutoRig_UI(object):
    ...
    def mainUI(self):
        ...
        self.allUIs["skinSurfAssociationCollection"] = cmds.radioCollection('skinSurfAssociationCollection', parent=self.allUIs["skinCopyFL"])
        ...
        self.allUIs["selectAllControls"] = cmds.button("selectAllControls", label=self.lang['i291_selectAllControls'], backgroundColor=(1.0, 1.0, 1.0), height=30, command=dpControls.ControlClass.getControlList, parent=self.allUIs["editSelectedControllerFL"])
