...
class FacialConnectionUI(object):
    ...
    def create_ui(self, app):
        ...
        cmds.button('facial_connect_create_targets_btn', label=self.ar.data.lang['m140_createTargets'], annotation=self.ar.data.lang["m141_createTargetsDesc"], width=220, command=self.app.create_targets_from_ui, align="center", parent='facial_connect_cl')
        ...
        cmds.button('facial_connect_recreate_btn', label=self.ar.data.lang['m265_recreateTargets'], annotation=self.ar.data.lang["m266_recreateTargetsDesc"], width=220, command=self.app.recreate_targets, parent='facial_connect_cl')
        cmds.separator(height=5, style="single", horizontal=True, parent='facial_connect_cl')
        cmds.text('facial_connect_connect_txt', label=self.ar.data.lang['m142_connectFacialAttr'], parent='facial_connect_cl')
        cmds.button('facial_connect_bs_btn', label=self.ar.data.lang['m170_blendShapes']+" - "+self.ar.data.lang['i185_animation'], annotation="Create selected facial controls.", width=220, command=self.app.connect_to_blendshape, parent='facial_connect_cl')
        cmds.button('facial_connect_joint_btn', label=self.ar.data.lang['i181_facialJoint']+" - "+self.ar.data.lang['i186_gaming'], annotation="Create default facial controls package.", width=220, command=self.app.connect_to_joints, parent='facial_connect_cl')
