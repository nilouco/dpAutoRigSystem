...
class FacialConnectionUI:
    ...
    def create_ui(self, app):
        ...
        width  = 230
        height = 330
        cmds.window('dpFacialConnectionWindow', title=f"{self.ar.data.lang['m085_facialConnection']} {self.ar.data.version}", widthHeight=(width, height), menuBar=False, sizeable=True, minimizeButton=False, maximizeButton=False, menuBarVisible=False, titleBar=True)
        # creating layout:
