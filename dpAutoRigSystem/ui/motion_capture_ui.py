...
class MotionCaptureUI:
    ...
    def create_ui(self, app):
        ...
        cmds.frameLayout('mocap_hik_mode_fl', label=f"Ik/Fk {self.ar.data.lang['v003_mode']}", collapsable=True, collapse=False, parent='mocap_cl')
        # radio buttons:
        ...
        cmds.radioButton('mocap_spine_ik_rb', label=f"{self.ar.data.lang['m011_spine']} Ik", annotation='spineIk')
        cmds.radioButton('mocap_spine_fk_rb', label=f"{self.ar.data.lang['m011_spine']} FK", annotation='spineFk')
        ...
        cmds.radioButton('mocap_arm_ik_rb', label=f"{self.ar.data.lang['m028_arm']} Ik", annotation='armIk')
        cmds.radioButton('mocap_arm_fk_rb', label=f"{self.ar.data.lang['m028_arm']} FK", annotation='armFk')
        ...
        cmds.radioButton('mocap_leg_ik_rb', label=f"{self.ar.data.lang['m030_leg']} Ik", annotation='legIk')
        cmds.radioButton('mocap_leg_fk_rb', label=f"{self.ar.data.lang['m030_leg']} FK", annotation='legFk')
        ...
        cmds.button('mocap_retargeting_bt', label=f"{self.ar.data.lang['m242_retargeting']} HumanIk", annotation='retargetHumanIk', width=240, command=self.app.hik_retarget, parent='mocap_cl')
