...
#        print("dpAutoRigSystem "+self.ar.data.lang['i346_loadedSuccess'])
    ...
    #     if option_var:
    #         last_item = self.ar.config.check_last_option_var(option_var, items[0], items)
...
class Fill(object):
    ...
    def start_modules(self):
        ...
        self.ar.startGuideModules(self.ar.data.integrated_folder, "start", "rig_guides_integrated_cl")
        # controllers
        self.ar.startGuideModules(self.ar.data.curve_simple_folder, "start", "ctr_simple_module_gl")
        self.ar.startGuideModules(self.ar.data.curve_combined_folder, "start", "ctr_combined_module_gl")
        # tools
        self.ar.startGuideModules(self.ar.data.tools_folder, "start", "tools_module_cl")
        # validators
        self.ar.startGuideModules(self.ar.data.checkin_folder, "start", "i208_checkin_module_cl")
