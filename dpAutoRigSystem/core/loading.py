...
class Opening:
    def create_opening_ui(self, version):
        ...
        cmds.window('dpar_load_win', title='dpAutoRigSystem', iconName='ar', widthHeight=(285, 208), menuBar=False, sizeable=False, minimizeButton=False, maximizeButton=False)
        cmds.columnLayout('dpar_load_cl', parent='dpar_load_win')
        cmds.image('loading_image', image=(f"{path.replace('core', 'icons')}/dp_loading_0{rand_value}.png"), backgroundColor=(0.8, 0.8, 0.8), parent='dpar_load_cl')
