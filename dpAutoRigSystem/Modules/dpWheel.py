    ...
    def rigModule(self, *args):
        ...
        if cmds.objExists(self.moduleGrp):
            ...
            for s, side in enumerate(sideList):
                ...
                # center joint:
                self.centerJoint = cmds.joint(name=side+self.userGuideName+"_"+self.dpUIinst.langDic[self.dpUIinst.langName]['m156_wheel']+"_Jnt", scaleCompensate=False)
                cmds.addAttr(self.centerJoint, longName='dpAR_joint', attributeType='float', keyable=False)
                # joint labelling:
                dpUtils.setJointLabel(self.centerJoint, s+jointLabelAdd, 18, self.userGuideName+"_"+self.dpUIinst.langDic[self.dpUIinst.langName]['m156_wheel'])
                # create end joint:
                self.endJoint = cmds.joint(name=side+self.userGuideName+"_"+self.dpUIinst.langDic[self.dpUIinst.langName]['m156_wheel']+"_JEnd", radius=0.5)
                # main joint:
                cmds.select(clear=True)
                self.mainJoint = cmds.joint(name=side+self.userGuideName+"_"+self.dpUIinst.langDic[self.dpUIinst.langName]['c058_main']+"_Jnt", scaleCompensate=False)
                cmds.addAttr(self.mainJoint, longName='dpAR_joint', attributeType='float', keyable=False)
                # joint labelling:
                dpUtils.setJointLabel(self.mainJoint, s+jointLabelAdd, 18, self.userGuideName+"_"+self.dpUIinst.langDic[self.dpUIinst.langName]['c058_main'])
                # create end joint:
                self.mainEndJoint = cmds.joint(name=side+self.userGuideName+"_"+self.dpUIinst.langDic[self.dpUIinst.langName]['c058_main']+"_JEnd", radius=0.5)
                
                # create controls:
                self.wheelCtrl = self.ctrls.cvControl("id_060_WheelCenter", side+self.userGuideName+"_"+self.dpUIinst.langDic[self.dpUIinst.langName]['m156_wheel']+"_Ctrl", r=self.ctrlRadius, d=self.curveDegree)
                self.mainCtrl = self.ctrls.cvControl("id_061_WheelMain", side+self.userGuideName+"_"+self.dpUIinst.langDic[self.dpUIinst.langName]['c058_main']+"_Ctrl", r=self.ctrlRadius*0.4, d=self.curveDegree)
                self.insideCtrl = self.ctrls.cvControl("id_062_WheelPivot", side+self.userGuideName+"_"+self.dpUIinst.langDic[self.dpUIinst.langName]['c011_revFoot_B'].capitalize()+"_Ctrl", r=self.ctrlRadius*0.2, d=self.curveDegree, rot=(0, 90, 0))
                self.outsideCtrl = self.ctrls.cvControl("id_062_WheelPivot", side+self.userGuideName+"_"+self.dpUIinst.langDic[self.dpUIinst.langName]['c010_revFoot_A'].capitalize()+"_Ctrl", r=self.ctrlRadius*0.2, d=self.curveDegree, rot=(0, 90, 0))
                ...
                self.toSteeringGrp = cmds.group(self.insideCtrl, name=side+self.userGuideName+"_"+self.dpUIinst.langDic[self.dpUIinst.langName]['c070_steering'].capitalize()+"_Grp")
                cmds.addAttr(self.toSteeringGrp, longName=self.dpUIinst.langDic[self.dpUIinst.langName]['c070_steering'], attributeType='bool', keyable=True)
                cmds.addAttr(self.toSteeringGrp, longName=self.dpUIinst.langDic[self.dpUIinst.langName]['c070_steering']+self.dpUIinst.langDic[self.dpUIinst.langName]['m151_invert'], attributeType='bool', keyable=True)
                cmds.setAttr(self.toSteeringGrp+"."+self.dpUIinst.langDic[self.dpUIinst.langName]['c070_steering'], 1)
                ...
                wheelAutoGrp = cmds.rename(wheelAutoGrp, side+self.userGuideName+"_"+self.dpUIinst.langDic[self.dpUIinst.langName]['m156_wheel']+"_Auto_Grp")
                ...
                # add attributes:
                cmds.addAttr(self.wheelCtrl, longName=self.dpUIinst.langDic[self.dpUIinst.langName]['c047_autoRotate'], attributeType="short", minValue=0, maxValue=1, defaultValue=1, keyable=True)
                cmds.addAttr(self.wheelCtrl, longName=self.dpUIinst.langDic[self.dpUIinst.langName]['c068_startFrame'], attributeType="long", defaultValue=1, keyable=False)
                cmds.addAttr(self.wheelCtrl, longName=self.dpUIinst.langDic[self.dpUIinst.langName]['c067_radius'], attributeType="float", min=0.01, defaultValue=self.ctrlRadius, keyable=True)
                cmds.addAttr(self.wheelCtrl, longName=self.dpUIinst.langDic[self.dpUIinst.langName]['c069_radiusScale'], attributeType="float", defaultValue=1, keyable=False)
                cmds.addAttr(self.wheelCtrl, longName=self.dpUIinst.langDic[self.dpUIinst.langName]['c021_showControls'], attributeType="long", min=0, max=1, defaultValue=1, keyable=True)
                cmds.addAttr(self.wheelCtrl, longName=self.dpUIinst.langDic[self.dpUIinst.langName]['c070_steering'], attributeType="short", minValue=0, maxValue=1, defaultValue=0, keyable=True)
                cmds.addAttr(self.wheelCtrl, longName=self.dpUIinst.langDic[self.dpUIinst.langName]['i037_to']+self.dpUIinst.langDic[self.dpUIinst.langName]['c070_steering'].capitalize(), attributeType="float", defaultValue=0, keyable=False)
                cmds.addAttr(self.wheelCtrl, longName=self.dpUIinst.langDic[self.dpUIinst.langName]['c070_steering']+self.dpUIinst.langDic[self.dpUIinst.langName]['c053_invert'].capitalize(), attributeType="long", min=0, max=1, defaultValue=1, keyable=False)
                cmds.addAttr(self.wheelCtrl, longName=self.dpUIinst.langDic[self.dpUIinst.langName]['c093_tryKeepUndo'], attributeType="long", min=0, max=1, defaultValue=1, keyable=False)
                ...
                cmds.setAttr(self.wheelCtrl+"."+self.dpUIinst.langDic[self.dpUIinst.langName]['c068_startFrame'], startFrameValue, channelBox=True)
                cmds.setAttr(self.wheelCtrl+"."+self.dpUIinst.langDic[self.dpUIinst.langName]['c070_steering'], steeringValue, channelBox=True)
                cmds.setAttr(self.wheelCtrl+"."+self.dpUIinst.langDic[self.dpUIinst.langName]['c021_showControls'], showControlsValue, channelBox=True)
                cmds.setAttr(self.wheelCtrl+"."+self.dpUIinst.langDic[self.dpUIinst.langName]['c070_steering']+self.dpUIinst.langDic[self.dpUIinst.langName]['c053_invert'].capitalize(), 1, channelBox=True)
                self.ctrls.setDefaultValue(self.wheelCtrl, self.dpUIinst.langDic[self.dpUIinst.langName]['c070_steering']+self.dpUIinst.langDic[self.dpUIinst.langName]['c053_invert'].capitalize(), 1)
                cmds.setAttr(self.wheelCtrl+"."+self.dpUIinst.langDic[self.dpUIinst.langName]['c093_tryKeepUndo'], 1, channelBox=True)
                if s == 1:
                    if cmds.getAttr(self.moduleGrp+".flip") == 1:
                        cmds.setAttr(self.wheelCtrl+"."+self.dpUIinst.langDic[self.dpUIinst.langName]['c070_steering']+self.dpUIinst.langDic[self.dpUIinst.langName]['c053_invert'].capitalize(), 0)
                        self.ctrls.setDefaultValue(self.wheelCtrl, self.dpUIinst.langDic[self.dpUIinst.langName]['c070_steering']+self.dpUIinst.langDic[self.dpUIinst.langName]['c053_invert'].capitalize(), 0)
                # set default values:
                self.ctrls.setDefaultValue(self.wheelCtrl, self.dpUIinst.langDic[self.dpUIinst.langName]['c068_startFrame'], startFrameValue)
                self.ctrls.setDefaultValue(self.wheelCtrl, self.dpUIinst.langDic[self.dpUIinst.langName]['c070_steering'], steeringValue)
                self.ctrls.setDefaultValue(self.wheelCtrl, self.dpUIinst.langDic[self.dpUIinst.langName]['c021_showControls'], showControlsValue)
                self.ctrls.setDefaultValue(self.wheelCtrl, self.dpUIinst.langDic[self.dpUIinst.langName]['c093_tryKeepUndo'], 1)
                
                # automatic rotation wheel setup:
                receptSteeringMD = cmds.createNode('multiplyDivide', name=side+self.userGuideName+"_"+self.dpUIinst.langDic[self.dpUIinst.langName]['c070_steering']+"_MD")
                inverseSteeringMD = cmds.createNode('multiplyDivide', name=side+self.userGuideName+"_"+self.dpUIinst.langDic[self.dpUIinst.langName]['c070_steering']+"_Inv_MD")
                steeringInvCnd = cmds.createNode('condition', name=side+self.userGuideName+"_"+self.dpUIinst.langDic[self.dpUIinst.langName]['c070_steering']+"_Inv_Cnd")
                cmds.setAttr(steeringInvCnd+".colorIfTrueR", 1)
                cmds.setAttr(steeringInvCnd+".colorIfFalseR", -1)
                cmds.connectAttr(self.wheelCtrl+"."+self.dpUIinst.langDic[self.dpUIinst.langName]['i037_to']+self.dpUIinst.langDic[self.dpUIinst.langName]['c070_steering'].capitalize(), receptSteeringMD+".input1X", force=True)
                cmds.connectAttr(self.wheelCtrl+"."+self.dpUIinst.langDic[self.dpUIinst.langName]['c070_steering'], receptSteeringMD+".input2X", force=True)
                ...
                cmds.connectAttr(self.wheelCtrl+"."+self.dpUIinst.langDic[self.dpUIinst.langName]['c070_steering']+self.dpUIinst.langDic[self.dpUIinst.langName]['c053_invert'].capitalize(), steeringInvCnd+".firstTerm", force=True)
                ...
                self.frontLoc = cmds.spaceLocator(name=side+self.userGuideName+"_"+self.dpUIinst.langDic[self.dpUIinst.langName]['m156_wheel']+"_Front_Loc")[0]
                self.oldLoc = cmds.spaceLocator(name=side+self.userGuideName+"_"+self.dpUIinst.langDic[self.dpUIinst.langName]['m156_wheel']+"_Old_Loc")[0]
                ...
                self.wheelAutoGrpLoc = cmds.spaceLocator(name=side+self.userGuideName+"_"+self.dpUIinst.langDic[self.dpUIinst.langName]['m156_wheel']+"_Auto_Loc")[0]
                ...
                expString = "if ("+self.wheelCtrl+"."+self.dpUIinst.langDic[self.dpUIinst.langName]['c047_autoRotate']+" == 1) {"+\
                        "\nif ("+self.wheelCtrl+"."+self.dpUIinst.langDic[self.dpUIinst.langName]['c093_tryKeepUndo']+" == 1) { undoInfo -stateWithoutFlush 0; };"+\
                        "\nfloat $radius = "+self.wheelCtrl+"."+self.dpUIinst.langDic[self.dpUIinst.langName]['c067_radius']+" * "+self.wheelCtrl+"."+self.dpUIinst.langDic[self.dpUIinst.langName]['c069_radiusScale']+\
                        ...
                        ";\nif (frame == "+self.wheelCtrl+"."+self.dpUIinst.langDic[self.dpUIinst.langName]['c068_startFrame']+") { "+wheelAutoGrp+".rotateZ = 0; };"+\
                        "\nif ("+self.wheelCtrl+"."+self.dpUIinst.langDic[self.dpUIinst.langName]['c093_tryKeepUndo']+" == 1) { undoInfo -stateWithoutFlush 1; };};"
                # expression:
                cmds.expression(name=side+self.userGuideName+"_"+self.dpUIinst.langDic[self.dpUIinst.langName]['m156_wheel']+"_Exp", object=self.frontLoc, string=expString)
                ...
                # geometry holder:
                self.geoHolder = cmds.polyCube(name=side+self.userGuideName+"_"+self.dpUIinst.langDic[self.dpUIinst.langName]['c046_holder']+"_Geo", constructionHistory=False)[0]
                ...
                # skinning:
                cmds.skinCluster(self.centerJoint, self.geoHolder, toSelectedBones=True, dropoffRate=4.0, maximumInfluences=3, skinMethod=0, normalizeWeights=1, removeUnusedInfluence=False, name=side+self.userGuideName+"_"+self.dpUIinst.langDic[self.dpUIinst.langName]['c046_holder']+"_SC")
                if self.loadedGeo:
                ...
                # clusters:
                upperClusterList = cmds.cluster(latticeList[1]+".pt[0:5][4:5][0:5]", relative=True, name=side+self.userGuideName+"_"+self.dpUIinst.langDic[self.dpUIinst.langName]['c044_upper']+"_Cls") #[deform, handle]
                middleClusterList = cmds.cluster(latticeList[1]+".pt[0:5][2:3][0:5]", relative=True, name=side+self.userGuideName+"_"+self.dpUIinst.langDic[self.dpUIinst.langName]['m033_middle']+"_Cls") #[deform, handle]
                lowerClusterList = cmds.cluster(latticeList[1]+".pt[0:5][0:1][0:5]", relative=True, name=side+self.userGuideName+"_"+self.dpUIinst.langDic[self.dpUIinst.langName]['c045_lower']+"_Cls") #[deform, handle]
                ...
                # deform controls:
                upperDefCtrl = self.ctrls.cvControl("id_063_WheelDeform", side+self.userGuideName+"_"+self.dpUIinst.langDic[self.dpUIinst.langName]['c044_upper']+"_Ctrl", r=self.ctrlRadius*0.5, d=self.curveDegree)
                middleDefCtrl = self.ctrls.cvControl("id_064_WheelMiddle", side+self.userGuideName+"_"+self.dpUIinst.langDic[self.dpUIinst.langName]['m033_middle']+"_Ctrl", r=self.ctrlRadius*0.5, d=self.curveDegree)
                lowerDefCtrl = self.ctrls.cvControl("id_063_WheelDeform", side+self.userGuideName+"_"+self.dpUIinst.langDic[self.dpUIinst.langName]['c045_lower']+"_Ctrl", r=self.ctrlRadius*0.5, d=self.curveDegree, rot=(0, 0, 180))
                ...
                cmds.connectAttr(self.wheelCtrl+"."+self.dpUIinst.langDic[self.dpUIinst.langName]['c021_showControls'], defCtrlGrp+".visibility", force=True)
