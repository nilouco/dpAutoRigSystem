...
class Foot(dpBaseClass.StartClass, dpLayoutClass.LayoutClass):
    ...
    def createGuide(self, *args):
        ...
        # bottom setup
        cvRFEZeroOut = dpUtils.zeroOut([self.cvRFELoc], True)
    ...
    def rigModule(self, *args):
        ...
        if cmds.objExists(self.moduleGrp):
            ...
            for s, side in enumerate(sideList):
                ...
                self.RFFZero = dpUtils.zeroOut([self.RFFGrp])[0]
                self.RFFZeroExtra = dpUtils.zeroOut([self.RFFZero])[0]
                self.RFFZeroFollow = dpUtils.zeroOut([self.RFFZero])[0]
                ...
                dpUtils.originedFrom(objName=self.RFECtrl, attrString=self.cvRFELoc)
                dpUtils.originedFrom(objName=self.middleFootCtrl, attrString=self.cvRFFLoc+";"+self.cvEndJoint)
