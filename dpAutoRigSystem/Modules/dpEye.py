...
class Eye(dpBaseClass.StartClass, dpLayoutClass.LayoutClass):
    ...
    def createEyelidSetup(self, side, lid, eyelidJnt, eyelidBaseJxt, eyelidMiddleBaseJxt, eyelidMiddleJnt, preset, rotCtrl, cvEyelidLoc, *args):
        ...
        eyelidCtrl = self.ctrls.cvControl("id_008_Eyelid", baseName+"_Ctrl", self.ctrlRadius*0.4, d=self.curveDegree, rot=rotCtrl, headDef=self.headDefValue, guideSource=self.guideModuleName+"__"+cvEyelidLoc.replace("_Guide", ":Guide"))
    ...
    def createIrisPupilSetup(self, s, side, type, codeName, jointLabelNumber, *args):
        ...
        ctrl = self.ctrls.cvControl(ctrlId, side+self.userGuideName+"_"+self.dpUIinst.lang[codeName]+"_1_Ctrl", r=ctrlRadius, d=self.curveDegree, headDef=self.headDefValue, guideSource=self.guideModuleName+"__"+cvLoc.replace("_Guide", ":Guide"))
    ...
    def rigModule(self, *args):
        ...
        if cmds.objExists(self.moduleGrp):
            ...
            for s, side in enumerate(sideList):
                ...
                self.utils.setJointLabel(self.eyeScaleJnt, s+jointLabelAdd, 18, self.userGuideName+"Scale_1")
                # jointScale position:
                ...
                if self.getModuleAttr(SPEC):
                    ...
                    self.utils.setJointLabel(self.eyeSpecJnt, s+jointLabelAdd, 18, self.userGuideName+"Specular_1")
                    ...
                    self.utils.setJointLabel(self.eyeSpecScaleJnt, s+jointLabelAdd, 18, self.userGuideName+"Specular_2")
