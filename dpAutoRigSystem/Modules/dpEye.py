    ...
    def rigModule(self, *args):
        ...
        if cmds.objExists(self.moduleGrp):
            ...
            for s, side in enumerate(sideList):
                ...
                if s == 1:
                    lEyeFkCtrlData = dpUtils.getTransformData(self.fkEyeCtrl)
                ...
                if self.getModuleAttr(SPEC):
                    ...
                    if s == 1:
                        noWSLEyeSpecScaleZeroGrpData = dpUtils.getTransformData(self.eyeSpecScaleZeroGrp, useWorldSpace=False)
                        lEyeSpecScaleZeroGrpData = dpUtils.getTransformData(self.eyeSpecScaleZeroGrp)
                        rEyeFkCtrlData = dpUtils.getTransformData(self.fkEyeCtrl)
                    self.eyeSpecScaleZeroGrp = dpUtils.zeroOut([self.eyeSpecScaleCtrl])[0]
