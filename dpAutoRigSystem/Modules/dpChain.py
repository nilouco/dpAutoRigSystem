        ...
        if cmds.objExists(self.moduleGrp):
            ...
            for s, side in enumerate(sideList):
                ...
                if n == (self.nJoints-1):
                    ...
                    cmds.addAttr(self.toParentExtremCtrl, longName="min"+self.langDic[self.langName]['c031_volumeVariation'], attributeType="float", minValue=0, defaultValue=0.01, maxValue=1, keyable=True)
                    cmds.addAttr(self.toParentExtremCtrl, longName=self.langDic[self.langName]['c118_active']+self.langDic[self.langName]['c031_volumeVariation'], attributeType="short", minValue=0, defaultValue=1, maxValue=1, keyable=True)
                ...
                cmds.connectAttr(self.toParentExtremCtrl+"."+self.langDic[self.langName]['c118_active']+self.langDic[self.langName]['c031_volumeVariation'], vvCond+'.firstTerm', force=True)
                cmds.connectAttr(self.toParentExtremCtrl+".min"+self.langDic[self.langName]['c031_volumeVariation'], vvClp+'.min.minR', force=True)
