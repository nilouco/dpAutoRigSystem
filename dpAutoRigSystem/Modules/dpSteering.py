    ...
    def rigModule(self, *args):
        ...
        if cmds.objExists(self.moduleGrp):
            ...
            for s, side in enumerate(sideList):
                ...
                # create a control:
                self.steeringCtrl = self.ctrls.cvControl("id_065_SteeringWheel", side+self.userGuideName+"_"+self.dpUIinst.langDic[self.dpUIinst.langName]['m158_steering']+"_Ctrl", r=self.ctrlRadius, d=self.curveDegree)
                self.mainCtrl = self.ctrls.cvControl("id_066_SteeringMain", side+self.userGuideName+"_"+self.dpUIinst.langDic[self.dpUIinst.langName]['c058_main']+"_Ctrl", r=self.ctrlRadius, d=self.curveDegree)
                ...
                # integrating setup:
                cmds.addAttr(self.steeringCtrl, longName=self.dpUIinst.langDic[self.dpUIinst.langName]['c071_limit'], defaultValue=500, attributeType="float", keyable=False)
                cmds.addAttr(self.steeringCtrl, longName=self.dpUIinst.langDic[self.dpUIinst.langName]['c049_intensity'], min=0, defaultValue=0.8, attributeType="float", keyable=False)
                cmds.addAttr(self.steeringCtrl, longName=self.dpUIinst.langDic[self.dpUIinst.langName]['c070_steering'], attributeType="float", keyable=False)
                cmds.setAttr(self.steeringCtrl+"."+self.dpUIinst.langDic[self.dpUIinst.langName]['c071_limit'], 500, channelBox=True)
                cmds.setAttr(self.steeringCtrl+"."+self.dpUIinst.langDic[self.dpUIinst.langName]['c049_intensity'], 0.8, channelBox=True)
                ...
                cmds.connectAttr(self.steeringCtrl+"."+self.dpUIinst.langDic[self.dpUIinst.langName]['c071_limit'], self.steeringUnitMD+".input1X", force=True)
                cmds.connectAttr(self.steeringUnitMD+".outputX", self.steeringCtrl+".minRotLimit.minRotZLimit", force=True)
                cmds.connectAttr(self.steeringCtrl+"."+self.dpUIinst.langDic[self.dpUIinst.langName]['c071_limit'], self.steeringCtrl+".maxRotLimit.maxRotZLimit", force=True)
                ...
                cmds.connectAttr(self.steeringCtrl+"."+self.dpUIinst.langDic[self.dpUIinst.langName]['c049_intensity'], self.steeringMD+".input2X", force=True)
                cmds.connectAttr(self.steeringMD+".outputX", self.steeringCtrl+"."+self.dpUIinst.langDic[self.dpUIinst.langName]['c070_steering'], force=True)
                
                # calibration attributes:
                steeringCalibrationList = [
                                            self.dpUIinst.langDic[self.dpUIinst.langName]['c071_limit'],
                                            self.dpUIinst.langDic[self.dpUIinst.langName]['c049_intensity']
                                            ]
