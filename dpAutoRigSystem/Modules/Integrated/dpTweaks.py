        ...
        if not userDetail == cancel:
            ...
            if not userIndirectSkin == cancel:
                ...
                if userDetail == complete:
                    ...
                    eyebrowInstance4.editUserName(eyebrowName4)
                    ...
                    cheekInstance2.editUserName(cheekName2)
