...
class Lens(BaseControl.ControlStartClass):
    ...
    def getLinearPoints(self, *args):
        ...
        """
        r = self.cvSize
        self.cvPointList = [(0, r, 0), (-0.6*r, 0, 0), (0, -r, 0), (0.6*r, 0, 0), (0, r, 0)]
    ...
    def getCubicPoints(self, *args):
        ...
        """
        r = self.cvSize
        self.cvPointList = [(0, r, 0), (0, r, 0), (0, r, 0), (-0.6*r, 0, 0), (0, -r, 0),
                            (0, -r, 0), (0, -r, 0), (0.6*r, 0, 0), (0, r, 0), (0, r, 0),
                            (0, r, 0)]
