...
class AddHandFollow(object):
    ...
    def dpSetHandFollowSDK(self, *args):
        ...
        cmds.setDrivenKeyframe(armWristIkCtrl+"_Orient_Grp_PaC."+self.headSubCtrl+"W4", currentDriver=armWristIkCtrl+"."+self.langDic[self.langName]['c032_follow'])
        ...
        for side in sideList:
            ...
            if cmds.objExists(armWristIkCtrl):
                if cmds.objExists(armWristIkCtrl+"."+self.langDic[self.langName]['c032_follow']):
                    ...
                    parentConst = cmds.parentConstraint(self.spineChestACtrl, self.globalCtrl, self.rootCtrl, self.spineHipsBCtrl, self.headSubCtrl, armWristIkCtrl+"_Orient_Grp", mo=True, name=armWristIkCtrl+"_Orient_Grp_PaC")
                    ...
                    cmds.setAttr(armWristIkCtrl+"_Orient_Grp_PaC."+self.headSubCtrl+"W4", 0)
                    ...
                    cmds.setAttr(armWristIkCtrl+"_Orient_Grp_PaC."+self.spineHipsBCtrl+"W3", 0)
                    cmds.setAttr(armWristIkCtrl+"_Orient_Grp_PaC."+self.headSubCtrl+"W4", 1)
                    self.dpSetHandFollowSDK(armWristIkCtrl)
